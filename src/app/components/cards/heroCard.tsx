...
const HeroCard = ({ name = 'Andrea', work = 'Webflow Designer', para = paraPlaceHolder }: HeroCardProps) => {
    return (
        <div className='hero-card-container p-5 lg:p-8 rounded-3xl'>
            ...
            <div className="flex-wrap lg:flex-nowrap  flex  gap-3 hero-higilights">
                ...
                <ButtonProdiver title='Hire Me' className='ml-auto w-max fancy-hover px-3.5 py-3 rounded-lg sm:mr-0' />
            </div>
        </div>
    )
}
